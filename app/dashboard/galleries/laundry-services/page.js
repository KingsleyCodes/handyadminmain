...
const CATEGORY = "laundry-services";

export default function LaundryServicesGalleryPage() {
  ...
  return (
    <div style={{ padding: "32px", maxWidth: "1200px", margin: "0 auto" }}>
      <h1 style={{ marginBottom: "8px", fontSize: "28px", fontWeight: "bold" }}>
        Laundry Services Gallery
      </h1>
      <p style={{ color: "#666", marginBottom: "32px" }}>
        Upload and manage photos displayed on the public Laundry Services page.
      </p>
